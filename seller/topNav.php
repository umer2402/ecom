     ...
     <div class="container-fixed flex justify-between items-stretch lg:gap-4" id="header_container">
      ...
      <div class="flex items-stretch" id="mega_menu_container">
       ...
       <div class="flex items-stretch" data-reparent="true" data-reparent-mode="prepend|lg:prepend" data-reparent-target="body|lg:#mega_menu_container">
        <!--Megamenu Wrapper-->
        <div class="hidden lg:flex lg:items-stretch" data-drawer="true" data-drawer-class="drawer drawer-start fixed z-10 top-0 bottom-0 w-full me-5 max-w-[250px] p-5 lg:p-0 overflow-auto" data-drawer-enable="true|lg:false" id="mega_menu_wrapper">
         <!--Megamenu-->
         <div class="menu flex-col lg:flex-row gap-5 lg:gap-7.5" data-menu="true" id="mega_menu">
          <!--Megamenu Item-->
          <div class="menu-item active">
           <a class="menu-link text-nowrap text-sm text-gray-800 font-medium menu-item-hover:text-primary menu-item-active:text-gray-900 menu-item-active:font-medium" href="index.html">
          ...
          <!--Megamenu Item-->
          <div class="menu-item" data-menu-item-placement="bottom-start" data-menu-item-placement-rtl="bottom-end" data-menu-item-toggle="accordion|lg:dropdown" data-menu-item-trigger="click|lg:hover">
           <div class="menu-link text-sm text-gray-800 menu-link-hover:text-primary menu-item-active:text-gray-900 menu-item-show:text-primary menu-item-here:text-gray-900 menu-item-active:font-medium menu-item-here:font-medium">
            <span class="menu-title text-nowrap">
             Profiles
            </span>
             ...
             <div class="grid lg:grid-cols-2 gap-5 lg:gap-10">
              <div class="menu menu-default menu-fit flex-col">
               ...
               <div class="grid lg:grid-cols-2 lg:gap-5">
                <div class="flex flex-col">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/creator.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/company.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/nft.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/blogger.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/crm.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/gamer.html" tabindex="0">
                   <span class="menu-icon">
                ...
                <div>
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/feeds.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/plain.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/profiles/modal.html" tabindex="0">
                   <span class="menu-icon">
              ...
              <div class="menu menu-default menu-fit flex-col">
               ...
               <div class="grid lg:grid-cols-2 lg:gap-5">
                <div class="flex flex-col">
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/projects/3-columns.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/projects/2-columns.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/works.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/teams.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/network.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/activity.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/campaigns/card.html" tabindex="0">
                   <span class="menu-icon">
                ...
                <div>
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/campaigns/list.html" tabindex="0">
                   <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="public-profile/empty.html" tabindex="0">
                   <span class="menu-icon">
          ...
          <!--End of Megamenu Item-->
          <!--Megamenu Item-->
          <div class="menu-item" data-menu-item-offset="-300px, 0" data-menu-item-offset-rtl="300px, 0" data-menu-item-overflow="true" data-menu-item-placement="bottom-start" data-menu-item-placement-rtl="bottom-end" data-menu-item-toggle="accordion|lg:dropdown" data-menu-item-trigger="click|lg:hover">
           ...
           <div class="menu-dropdown flex-col lg:flex-row gap-0 w-full lg:max-w-[1240px]">
            <div class="lg:w-[250px] mt-2 lg:mt-0 lg:border-r lg:border-r-gray-200 rounded-xl lg:rounded-l-xl lg:rounded-r-none shrink-0 px-3 py-4 lg:p-7.5 bg-light-active dark:bg-coal-500 dark:lg:border-r-coal-100">
             ...
             <div class="menu menu-default menu-fit flex-col">
              ...
              <div class="menu-item">
               <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="account/notifications.html">
                <span class="menu-icon">
              ...
              <div class="menu-item">
               <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="account/api-keys.html">
                <span class="menu-icon">
              ...
              <div class="menu-item">
               <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="account/appearance.html">
                <span class="menu-icon">
              ...
              <div class="menu-item">
               <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="account/invite-a-friend.html">
                <span class="menu-icon">
              ...
              <div class="menu-item">
               <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="account/activity.html">
                <span class="menu-icon">
             ...
             <div class="grid lg:grid-cols-5 gap-5">
              <div class="flex flex-col">
               ...
               <div class="menu menu-default menu-fit flex-col">
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/home/company-profile.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Company Profile
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/home/settings-sidebar.html" tabindex="0">
                  <span class="menu-title grow-0">
                   With Sidebar
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/home/settings-enterprise.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Enterprise
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/home/settings-plain.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Plain
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/home/settings-modal.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Modal
                  </span>
                 </a>
              ...
              <div class="flex flex-col">
               ...
               <div class="menu menu-default menu-fit flex-col">
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/billing/enterprise.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Enterprise
                  </span>
                 </a>
              ...
              <div class="flex flex-col">
               ...
               <div class="menu menu-default menu-fit flex-col">
                <div class="menu-item">
                 <a class="menu-link" href="account/security/get-started.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Get Started
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/security/allowed-ip-addresses.html" tabindex="0">
                  <span class="menu-title grow-0">
                   IP Addresses
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/security/privacy-settings.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Privacy Settings
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/security/device-management.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Device Management
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/security/backup-and-recovery.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Backup & Recovery
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/security/current-sessions.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Current Sessions
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/security/security-log.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Security Log
                  </span>
                 </a>
              ...
              <div class="flex flex-col">
               ...
               <div class="menu menu-default menu-fit flex-col">
                <div class="menu-item">
                 <a class="menu-link" href="account/members/team-starter.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Teams Starter
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/members/members-starter.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Members Starter
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/members/team-members.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Team Members
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/members/import-members.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Import Members
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/members/permissions-toggle.html" tabindex="0">
                  <span class="menu-title grow-0">
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/members/permissions-check.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Persmissions - Check
                  </span>
                 </a>
              ...
              <div class="flex flex-col">
               ...
               <div class="menu menu-default menu-fit flex-col">
                <div class="menu-item">
                 <a class="menu-link" href="account/integrations.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Integrations
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/notifications.html" tabindex="0">
                  <span class="menu-title grow-0">
                   Notifications
                  </span>
                 </a>
                ...
                <div class="menu-item">
                 <a class="menu-link" href="account/api-keys.html" tabindex="0">
                  <span class="menu-title grow-0">
                   API Keys
                  </span>
                 </a>
             ...
             <div class="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
              <div class="grid lg:grid-cols-2 gap-5">
               <div class="flex flex-col gap-5">
                <h3 class="flex items-center gap-1.5 text-sm text-gray-800 font-semibold leading-none ps-2.5 h-3.5">
                 User Cards
                </h3>
                <div class="menu menu-default menu-fit flex-col">
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-cards/mini-cards.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Mini Cards
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-cards/team-crew.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Team Crew
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-cards/nft.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Authors
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-cards/social.html" tabindex="0">
                   <span class="menu-title grow-0">
                    NFT Users
                   </span>
                  </a>
               ...
               <div class="flex flex-col gap-5">
                ...
                <div class="menu menu-default menu-fit flex-col">
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-table/team-crew.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Team Crew
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-table/app-roster.html" tabindex="0">
                   <span class="menu-title grow-0">
                    App Roster
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-table/market-authors.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Market Authors
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-table/saas-users.html" tabindex="0">
                   <span class="menu-title grow-0">
                    SaaS Users
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-table/store-clients.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Store Clients
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="network/user-table/visitors.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Visitors
                   </span>
                  </a>
           ...
           <div class="menu-dropdown flex-col gap-0 w-full lg:max-w-[670px]">
            <div class="flex flex-col lg:flex-row">
             <div class="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
              <div class="grid lg:grid-cols-2 gap-5">
               <div class="flex flex-col">
                ...
                <div class="menu menu-default menu-fit flex-col">
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/classic/sign-in.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Sign In
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/classic/sign-up.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Sign Up
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/classic/2fa.html" tabindex="0">
                   <span class="menu-title grow-0">
                    2FA
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/classic/check-email.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Check Email
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/classic/reset-password/enter-email.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Enter Email
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/classic/reset-password/check-email.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Check Email
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/classic/reset-password/change-password.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Change Password
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/classic/reset-password/password-changed.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Password is Changed
                   </span>
                  </a>
               ...
               <div class="flex flex-col">
                ...
                <div class="menu menu-default menu-fit flex-col">
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/branded/sign-in.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Sign In
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/branded/sign-up.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Sign Up
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/branded/2fa.html" tabindex="0">
                   <span class="menu-title grow-0">
                    2FA
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/branded/check-email.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Check Email
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/branded/reset-password/enter-email.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Enter Email
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/branded/reset-password/check-email.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Check Email
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/branded/reset-password/change-password.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Change Password
                   </span>
                  </a>
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="authentication/branded/reset-password/password-changed.html" tabindex="0">
                   <span class="menu-title grow-0">
                    Password is Changed
                   </span>
                  </a>
             ...
             <div class="lg:w-[250px] mb-4 lg:mb-0 lg:border-l lg:border-l-gray-200 rounded-xl lg:rounded-r-xl lg:rounded-l-none shrink-0 px-3 py-4 lg:p-7.5 bg-light-active dark:bg-coal-500 dark:lg:border-l-coal-100">
              ...
              <div class="menu menu-default menu-fit flex-col">
               <div class="menu-item">
                <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="authentication/welcome-message.html">
                 <span class="menu-icon">
               ...
               <div class="menu-item">
                <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="authentication/account-deactivated.html">
                 <span class="menu-icon">
               ...
               <div class="menu-item">
                <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="authentication/error-404.html">
                 <span class="menu-icon">
               ...
               <div class="menu-item">
                <a class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100" href="authentication/error-500.html">
                 <span class="menu-icon">
          ...
          <!--End of Megamenu Item-->
          <!--Megamenu Item-->
          <div class="menu-item" data-menu-item-offset="0,0|lg:-20px, 0" data-menu-item-offset-rtl="0,0|lg:20px, 0" data-menu-item-overflow="true" data-menu-item-placement="bottom-start" data-menu-item-placement-rtl="bottom-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
           <div class="menu-link text-sm text-gray-700 font-medium menu-link-hover:text-primary menu-item-active:text-gray-900 menu-item-show:text-primary menu-item-here:text-gray-900 menu-item-active:font-semibold menu-item-here:font-semibold">
            <span class="menu-title text-nowrap">
             Help
            </span>
           ...
           <div class="menu-dropdown menu-default py-2.5 w-full max-w-[220px]">
            ...
            <div class="menu-item" data-menu-item-placement="right-start" data-menu-item-placement-rtl="left-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
             <div class="menu-link">
              <span class="menu-icon">
               <i class="ki-filled ki-information">
               </i>
       ...
       <div class="dropdown" data-dropdown="true" data-dropdown-offset="10px, 10px" data-dropdown-offset-rtl="-10px, 10px" data-dropdown-placement="bottom-end" data-dropdown-placement-rtl="bottom-start" data-dropdown-trigger="click|lg:click">
        ...
        <div class="dropdown-content light:border-gray-300 w-screen max-w-[320px]">
         ...
         <div class="grid p-5 border-t border-t-gray-200">
          <a class="btn btn-sm btn-light justify-center" href="account/api-keys.html">
           Go to Apps
          </a>
         </div>
        </div>
       ...
       <div class="menu" data-menu="true">
        <div class="menu-item" data-menu-item-offset="20px, 10px" data-menu-item-offset-rtl="-20px, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
         ...
         <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
           ...
           <div class="flex items-center gap-2">
            <img alt="" class="size-9 rounded-full border-2 border-success" src="assets/media/avatars/300-2.png">
             <div class="flex flex-col gap-1.5">
              ...
              <a class="text-xs text-gray-600 hover:text-primary font-medium leading-none" href="account/home/get-started.html">
               c.fisher@gmail.com
              </a>
             </div>
            </img>
          ...
          <div class="flex flex-col">
           <div class="menu-item">
            <a class="menu-link" href="public-profile/profiles/default.html">
             <span class="menu-icon">
              <i class="ki-filled ki-badge">
              </i>
             </span>
           ...
           <div class="menu-item">
            <a class="menu-link" href="account/home/user-profile.html">
             <span class="menu-icon">
           ...
           <div class="menu-item" data-menu-item-offset="-50px, 0" data-menu-item-placement="left-start" data-menu-item-placement-rtl="right-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
            ...
            <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[220px]">
             <div class="menu-item">
              <a class="menu-link" href="account/home/get-started.html">
               <span class="menu-icon">
                <i class="ki-filled ki-coffee">
                </i>
               </span>
             ...
             <div class="menu-item">
              <a class="menu-link" href="account/security/overview.html">
               <span class="menu-icon">
             ...
             <div class="menu-item">
              <a class="menu-link" href="account/members/teams.html">
               <span class="menu-icon">
             ...
             <div class="menu-item">
              <a class="menu-link" href="account/integrations.html">
               <span class="menu-icon">
          ...
          <div class="flex flex-col">
           ...
           <div class="menu-item px-4 py-1.5">
            <a class="btn btn-sm btn-light justify-center" href="logout.php">
             Log out
            </a>
           </div>
          </div>
